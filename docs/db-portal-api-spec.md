...
| sra | ES | organism, accessibility, libraryStrategy, librarySource, librarySelection, platform, instrumentModel, libraryLayout, analysisType |
| jga | ES | organism, accessibility, studyType, datasetType, vendor |
