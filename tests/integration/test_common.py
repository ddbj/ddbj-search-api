...
def test_request_id_auto_generated(app: TestClient):
...
def test_request_id_echoes_client_value(app: TestClient):
...
def test_cors_allow_origin(app: TestClient):
...
def test_error_404_rfc7807_structure(app: TestClient):
...
def test_error_404_request_id_in_body(app: TestClient):
...
def test_invalid_db_type_returns_404(app: TestClient):
